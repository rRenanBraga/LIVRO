...
<div class = "formulario">  
        ...
        <ul class="nav-list">
          <li><a href="<?=URL?>/paginas/conto" data-tooltip="tooltip" title="conto">CONTO</a></li>
          <li><a href="<?=URL?>/paginas/historia" data-tooltip="tooltip" title="historia">HISTÓRIA</a></li>
          <li><a href="<?=URL?>/paginas/politica" data-tooltip="tooltip" title="politica">POLÍTICA</a></li>
